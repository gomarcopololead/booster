  ...
  describe('the `dispatchCommand` method', () => {
    it('fails if the command "version" is not sent', () => {
      ...
      Booster.configure('test', async (config) => {
        await expect(
          new BoosterCommandDispatcher(config, logger).dispatchCommand(command as any, {} as any)
    ...
    it('fails if the current user is not authorized', async () => {
      ...
      await expect(
        new BoosterCommandDispatcher(config as any, logger).dispatchCommand(commandEnvelope as any, {} as any)
    ...
    it('calls the handler method of a registered command', async () => {
      ...
      await new BoosterCommandDispatcher(config as any, logger).dispatchCommand(commandEnvelope as any, {} as any)
